""" Airflow Operator to load data into Redshift dimension tables"""
...
class LoadDimensionOperator(BaseOperator):
    ...
    @apply_defaults
    def __init__(
        self, redshift_conn_id="", table="", append_data=False, sql="", *args, **kwargs
    ):
    ...
    def execute(self, context):
        ...
        if not self.append_data:
            self.log.info("Clearing data from destination Redshift dimension table")
